...
Next port work should move beyond the scaffold into the larger Vink subsystems:
...
3. Port the latest Vink book/page pipeline only after the font engine is stable.
