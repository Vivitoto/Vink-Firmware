...
def vink3_source_invariants(main_cpp: str) -> None:
    ...
    assert_contains(upstream, "kVinkPaperS3FirmwareVersion = \"v0.3.20\"", "single firmware version constant matches the manifest top version")
    ...
    assert_contains(reader_book_cpp, "VPG3", "reader page cache validates file size/fingerprint/schema")
