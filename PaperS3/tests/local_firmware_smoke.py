...
def vink3_source_invariants(main_cpp: str) -> None:
    ...
    assert_contains(runtime_cpp, "external reset after running session -> side-key shutdown path", "side-key reset while running is converted into shutdown")
    ...
    assert_contains(ui_cpp, "renderSystemLogs", "settings page exposes persistent system logs")
    ...
    assert_contains(ui_cpp, "appendWrappedLogLine", "system log page wraps long records instead of truncating them")
