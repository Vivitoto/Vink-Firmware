...
def vink3_source_invariants(main_cpp: str) -> None:
    ...
    assert_contains(display_cpp, "constexpr uint16_t kStripW = 56", "page-turn animation uses overlapping narrow strips for continuous refresh")
    assert_contains(display_cpp, "Overlap adjacent updates", "page-turn animation repairs the final left-edge seam")
