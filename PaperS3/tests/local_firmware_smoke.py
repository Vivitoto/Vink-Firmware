...
def vink3_source_invariants(main_cpp: str) -> None:
    ...
    assert_contains(display_cpp, "pageTurnScrollStripWidth", "page-turn speed is controlled by explicit strategy strip widths")
    assert_contains(display_cpp, "return 90", "balanced page-turn sweep uses fewer/wider strips for faster animation")
