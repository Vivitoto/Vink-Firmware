...
def vink3_source_invariants(main_cpp: str) -> None:
    ...
    assert_contains(display_cpp, "return 32", "page-turn sweep uses a narrow line-like strip instead of a blackboard eraser block")
    assert_contains(display_cpp, "the old fastest DU mode is too ghosty", "page-turn animation no longer exposes the unusable high-speed DU mode")
