...
def vink3_source_invariants(main_cpp: str) -> None:
    ...
    assert_contains(display_cpp, "M5.Display.setEpdMode(mode)", "page-turn animation preserves the selected EPD waveform mode")
    assert_contains(display_cpp, "M5.Display.setClipRect", "page-turn animation uses clipped real-page strip refreshes")
