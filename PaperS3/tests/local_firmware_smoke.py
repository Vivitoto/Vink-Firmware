...
def vink3_source_invariants(main_cpp: str) -> None:
    ...
    assert_contains(upstream, "kVinkPaperS3FirmwareVersion = \"v0.3.15\"", "single firmware version constant matches the manifest top version")
    ...
    assert_contains(full_font_h, "g_vink_book_font_data", "v0.3 full Vink font is compiled as PROGMEM")
