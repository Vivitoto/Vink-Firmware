...
def vink3_source_invariants(main_cpp: str) -> None:
    ...
    assert_contains(display_cpp, "Exact v0.4.28-rc edcscroll behavior", "normal M5GFX page turns intentionally restore the known EDCBook-flavor edcscroll behavior")
    assert_contains(display_cpp, "? kLowRefresh", "v0.4.28 edcscroll uses the low DU-like waveform for quality/text scheduled turns")
    ...
    assert_contains(display_cpp, "v0.4.28-rc edcscroll default", "normal M5GFX page turns use the known EDCBook-flavor edcscroll path")
    ...
    assert_contains(display_cpp, "v0.4.28 edcscroll Panel_EPD wavefront", "page-turn logs must state the restored v0.4.28 Panel_EPD wavefront path")
