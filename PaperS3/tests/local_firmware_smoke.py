...
def vink3_source_invariants(main_cpp: str) -> None:
    ...
    assert_contains(display_cpp, "thresholds every pixel through a 4x4 Bayer", "DisplayService documents why epd_fastest cannot be the reader/UI default")
    ...
    assert_contains(display_cpp, "panel->displayScroll(0, 0, kPaperS3Width, kPaperS3Height, stripWidth, rtl);", "normal no-epdiy page turns do not pass private waveform/residue parameters")
