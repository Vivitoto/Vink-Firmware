 ...
 */
/** EDCBook-style directional scroll page-turn using offset table. */
enum EpdDrawError epd_draw_base_scroll(
    ...
    const bool* drawn_lines, const uint8_t* drawn_columns,
    const EpdWaveform* waveform,
    int* scroll_offsets, int scroll_count, int scroll_direction
);
