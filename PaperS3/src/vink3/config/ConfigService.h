...
struct VinkConfig {
    ...
    uint8_t readerMiddleRefreshEvery = 10; // epd_fast cleanup period during reading
    uint8_t readerFullRefreshEvery = 20;   // GC16 period during reading; 0 = never by page count
...
public:
    ...
    void setReaderRefreshThresholds(uint8_t middleEvery, uint8_t fullEvery);
